...
# check arguments for ANT_HOME and JAVA_HOME overrides
numArgs=$#
ANT_ARGS=
...
for jardir in ${APP_LIB_FOLDER} ${APP_BIN_FOLDER} ${ANT_LIB_FOLDER}; do
...
case ${JAVA_HOME} in
	...
	*)  ${JAVA_HOME}/bin/java -cp $APP_CLASSPATH net.community.apps.apache.ant.antrunner.Main ${ANT_ARGS};;
esac
