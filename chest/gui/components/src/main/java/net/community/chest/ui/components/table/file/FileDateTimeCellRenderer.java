...
public class FileDateTimeCellRenderer extends DateTimeCellRenderer {
            ...
            boolean isSelected, boolean hasFocus, int row, int column)
    {
        if (value instanceof File)
            return super.getTableCellRendererComponent(table, new Date(((File) value).lastModified()), isSelected, hasFocus, row, column);
        else if (value instanceof String)
            return super.getTableCellRendererComponent(table, new Date(new File(value.toString()).lastModified()), isSelected, hasFocus, row, column);
        else
