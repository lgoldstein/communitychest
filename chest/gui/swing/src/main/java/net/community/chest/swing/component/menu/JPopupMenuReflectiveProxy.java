...
public class JPopupMenuReflectiveProxy<M extends JPopupMenu> extends JComponentReflectiveProxy<M> {
	...
	protected JPopupMenuReflectiveProxy (Class<M> objClass, boolean registerAsDefault)
	...
	public static final JPopupMenuReflectiveProxy<JPopupMenu>	POPUPMENU=
				new JPopupMenuReflectiveProxy<JPopupMenu>(JPopupMenu.class, true);
}
