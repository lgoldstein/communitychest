...
public class JColorChooserReflectiveProxy<C extends JColorChooser> extends JComponentReflectiveProxy<C> {
    protected JColorChooserReflectiveProxy (Class<C> objClass, boolean registerAsDefault)
    ...
    public static final JColorChooserReflectiveProxy<JColorChooser>    CC=
        new JColorChooserReflectiveProxy<JColorChooser>(JColorChooser.class, true);
}
