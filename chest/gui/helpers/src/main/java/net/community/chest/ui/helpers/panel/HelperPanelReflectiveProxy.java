...
public class HelperPanelReflectiveProxy<P extends HelperPanel> extends BasePanelReflectiveProxy<P> {
	...
	protected HelperPanelReflectiveProxy (Class<P> objClass, boolean registerAsDefault)
	...
	public static final HelperPanelReflectiveProxy<HelperPanel>	HLPRPNL=
		new HelperPanelReflectiveProxy<HelperPanel>(HelperPanel.class, true) {
