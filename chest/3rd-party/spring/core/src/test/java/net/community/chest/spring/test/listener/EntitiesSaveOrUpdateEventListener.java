...
/**
 * @author Lyor G.
 * @since Jul 22, 2010 12:33:09 PM
 * Intercepts the calls to save or update an entity
 */
public class EntitiesSaveOrUpdateEventListener extends DefaultSaveOrUpdateEventListener
			implements BeanNameAware {
	/**
	 * 
	 */
	private static final long serialVersionUID = 7862852402788109516L;
	public EntitiesSaveOrUpdateEventListener ()
	{
		super();
	}
	/**
