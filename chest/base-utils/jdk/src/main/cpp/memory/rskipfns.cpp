...
size_t skip_byter (const BYTE buf[], BYTE value, size_t count)
{
   const BYTE  *b_p;
   size_t 		idx;
...
size_t skip_wordr (const WORD buf[], WORD value, size_t count)
{
   const WORD  *b_p;
   size_t 		idx;
...
size_t skip_dwordr (const DWORD buf[], DWORD value, size_t count)
{
   const DWORD *b_p;
   size_t 		idx;
