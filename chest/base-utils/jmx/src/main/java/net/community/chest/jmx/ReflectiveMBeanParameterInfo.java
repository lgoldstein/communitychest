...
public class ReflectiveMBeanParameterInfo extends MBeanParameterInfo {
    ...
    public final /* no cheating */ Class<?> getParameterClass ()
    {
        return _paramType;
    }
    ...
    public ReflectiveMBeanParameterInfo (String pName, Class<?> type, String pDesc) throws IllegalArgumentException
    {
        ...
        if (null == (_paramType=type))
            throw new IllegalArgumentException(ClassUtil.getConstructorExceptionLocation(getClass()) + " no parameter type class specified");
    }
