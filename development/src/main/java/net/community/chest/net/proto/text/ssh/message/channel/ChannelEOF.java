 ...
 *
 * @author Lyor G.
 * @since Jul 12, 2009 11:17:19 AM
 */
public class ChannelEOF extends AbstractSSHMsgEncoder<ChannelEOF> {
	/**
	 * 
	 */
	private static final long serialVersionUID = -6293729945037941755L;
	public ChannelEOF ()
	{
		super(SSHMsgCode.SSH_MSG_CHANNEL_EOF);
	}
	 ...
	 */
	@Override
	public ChannelEOF read (final InputStream in) throws IOException
	{
	 ...
	 */
	@Override
	public ChannelEOF decode (SSHInputDataDecoder in) throws IOException
	{
		if (null == in)
