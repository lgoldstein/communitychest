...
public class UserAuthRequest extends AbstractSSHMsgEncoder<UserAuthRequest> {
	...
	// known method name(s) as per RFC 4252
	public static final String	PUBLIC_KEY_METHOD_NAME="publickey",
								PASSWORD_METHOD_NAME="password",
								HOST_BASED_METHOD_NAME="hostbased",
								NO_METHOD_NAME="none";
	...
	public UserAuthRequest read (InputStream in) throws IOException
	{
		...
		// TODO add method specific fields
		return this;
	}
	/*
