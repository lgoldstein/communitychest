 ...
 *
 * @author Lyor G.
 * @since Jul 12, 2009 12:18:50 PM
 */
public class ExecChannelRequest extends AbstractChannelRequestSpecificTypeData<ExecChannelRequest> {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1252445325925271411L;
	public static final String	REQ_TYPE="exec";
	public ExecChannelRequest ()
	{
		super(REQ_TYPE);
	}
	 ...
	 */
	@Override
	public ExecChannelRequest read (final InputStream in) throws IOException
	{
		setCommand(SSHProtocol.readASCIIString(in));
		return this;
	}
	/*
	 ...
	 */
	@Override
	public ExecChannelRequest decode (SSHInputDataDecoder in) throws IOException
	{
		if (null == in)
			throw new IOException("decode(" + getRequestType() + ") no " + SSHInputDataDecoder.class.getSimpleName() + " instance");

		setCommand(in.readASCII());
		return this;
	}
	/*
	...
	{
		SSHProtocol.writeStringBytes(out, true, getCommand());
	}
	/*
