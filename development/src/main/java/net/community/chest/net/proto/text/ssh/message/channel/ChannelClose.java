 ...
 *
 * @author Lyor G.
 * @since Jul 12, 2009 11:19:56 AM
 */
public class ChannelClose extends AbstractSSHMsgEncoder<ChannelClose> {
	/**
	 * 
	 */
	private static final long serialVersionUID = -5063868493769344039L;
	public ChannelClose ()
	{
		super(SSHMsgCode.SSH_MSG_CHANNEL_CLOSE);
	}
	 ...
	 */
	@Override
	public ChannelClose read (final InputStream in) throws IOException
	{
	 ...
	 */
	@Override
	public ChannelClose decode (SSHInputDataDecoder in) throws IOException
	{
		if (null == in)
