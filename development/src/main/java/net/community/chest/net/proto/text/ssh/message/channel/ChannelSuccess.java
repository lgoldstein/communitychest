 ...
 *
 * @author Lyor G.
 * @since Jul 12, 2009 11:22:21 AM
 */
public class ChannelSuccess extends AbstractSSHMsgEncoder<ChannelSuccess> {
	/**
	 * 
	 */
	private static final long serialVersionUID = 8256163862341973484L;
	public ChannelSuccess ()
	{
		super(SSHMsgCode.SSH_MSG_CHANNEL_SUCCESS);
	}
	 ...
	 */
	@Override
	public ChannelSuccess read (final InputStream in) throws IOException
	{
	 ...
	 */
	@Override
	public ChannelSuccess decode (SSHInputDataDecoder in) throws IOException
	{
		if (null == in)
