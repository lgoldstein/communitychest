...
public class BranchDaoImpl
		extends AbstractIdentifiedJpaDaoImpl<Branch>
	...
	public Branch findByBranchCode(int code) {
		...
		final TypedQuery<Branch>	query=getNamedQuery("findByBranchCode")
	...
	public Branch findByBranchName(String name) {
		...
		final TypedQuery<Branch>	query=getNamedQuery("findByBranchName")
	...
	public List<Branch> findByBranchLocation(String location) {
		...
		final TypedQuery<Branch>	query=getNamedQuery("findByBranchLocation")
	...
	public List<Branch> findByBranchBankCode(int bankCode) {
		...
		final TypedQuery<Branch>	query=getNamedQuery("findByBranchBankCode")
